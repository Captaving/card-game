...
const FACTIONS = {
    ...
    blacklily: {
        ...
        leaders: [
            { id: "black_lily_leader", name: "Черная Лиллия", effect: "Создайте 1 призрака. Максимум 3 раза можно использовать" },
            { id: "apocalypse_leader", name: "Апокалипсис", effect: "Призовите одного из вестников (Голод, Смерть, Чума, Война) из колоды" },
        ...
        cards: [
            ...
            { id: "b8", name: "Чернокнижник", type: "purple", line: "any", power: 4, influence: 8, maxCopies: 2, effect: "Заряд(2): При размещении воскрешает карту из отбоя." },
            { id: "b9", name: "Призрак", type: "white", line: "any", power: 1, influence: 2, maxCopies: 4, effect: "Призрак. Очень слабый, но призывается из других карт." },
    ...
    dryads: {
        id: 'dryads',
        name: "Дриады Нидолиона",
        color: "#2e7d32",
        emblem: "images/Дриады Нидолиона.png",
        leaders: [
            { id: "eliana_princess", name: "Принцесса Элиана", effect: "Ваши лучники наносят по 1 урону выбранной карте противника" },
            { id: "eliana_warrior", name: "Элиана Воительница", effect: "Сыграйте ловушку, если она сработала, нанесите этой карте еще 4 урона" },
            { id: "eliana_spirit", name: "Элиана Дух Леса", effect: "Перемещает одну карту противника из его ряда в другой" }
        ],
        cards: [
            ...
            { id: "d9", name: "Повелительница Дриад Элиана", type: "gold", line: "any", power: 8, influence: 15, maxCopies: 1, effect: "Лидер дриад." },
    ...
    wizards: {
        ...
        leaders: [
            ...
            { id: "kristoff", name: "Чародей Кристофф", effect: "Копирует умение лидера противника" },
            { id: "aleksios", name: "Чародей Алексиос", effect: "Посмотрите 3 верхние карты колоды противника и возьмите одну себе в руку" }
        ],
        cards: [
