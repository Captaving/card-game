...
const server = http.createServer((req, res) => {
  // Обработка простых HTTP-запросов (для проверки работоспособности)
...
// Внешний URL для клиента (опционально, можно удалить если не используется)
// const EXTERNAL_URL = 'wss://lily-wars.duckdns.org/ws';
